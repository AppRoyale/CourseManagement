...
-- --------------------------------------------------
-- Date Created: 05/08/2013 20:27:14
...
-- Creating foreign key on [Tutors_Id] in table 'Courses'
ALTER TABLE [dbo].[Courses]
ADD CONSTRAINT [FK_CourseTutor]
    FOREIGN KEY ([Tutors_Id])
    REFERENCES [dbo].[Persons_Tutor]
        ([Id])
    ON DELETE NO ACTION ON UPDATE NO ACTION;

-- Creating non-clustered index for FOREIGN KEY 'FK_CourseTutor'
CREATE INDEX [IX_FK_CourseTutor]
ON [dbo].[Courses]
    ([Tutors_Id]);
GO
